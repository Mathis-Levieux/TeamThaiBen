...
class Albums
{
    ...
    public function getAlbumName($id) // On crée une méthode qui prend en paramètre $id et qui retourne un tableau associatif
    {
        ...
        json_encode($albumName); // On encode en JSON
