    ...
    <nav class="navbar-dashboard mt-5 m-3">
        <ul class="nav flex-column ps-5 ms-5">
            ...
            <li class="nav-item pt-3">
                <a class="nav-link" href="controller-dashboard-events.php">Calendrier</a>
            </li>
            <li class="nav-item pt-3">
                <a class="nav-link" href="controller-dashboard-news.php">Articles</a>
            </li>
            <li class="nav-item pt-3">
                <a class="nav-link" href="controller-dashboard-files.php">Fichiers</a>
            </li>
        </ul>
    </nav>
</header>